...
export class ReportsService {
    ...
    async generateBookingReceipt(data: any, res: Response) {
    ...
    async generateInvoicePDF(order: any, car: any, user: any): Promise<any> {
    ...
    async generateYearlyReportPDF(year: number, stats: any[]): Promise<any> {
